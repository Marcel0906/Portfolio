    ...
    <div className="about-page">
      ...
      {language === "de" ? (
        ...
        <p>
          ...
          <>
          <p>
              I have been fascinated by computer science for years. Privately, I have
              enjoyed learning about developments in AI, security technologies, and
              the expansion of mobile and fixed networks in Germany. This has, for
              example, resulted in me advising friends and family members on the
              assembly and purchase of PCs, laptops, and smartphones. In such a
              rapidly growing industry as IT, it is important to stay up to date and
              learn about new technologies and developments. Therefore, it is a
              challenge for me to take the opportunity to work as a Full-Stack
              Web/Software Developer in an IT company that develops exciting projects
              with innovative and new technologies.
            </p>
            <p>
              Reliability, self-taught learning, solution-oriented, independent work
              have characterized my previous work behavior. The timely completion and
              submission of my term papers during my studies, as well as teamwork with
              other DCI students in my further education at DCI, have solidified my
              experience in agile project management and team leadership tasks with
              project presentations.
            </p>
            <p>
              My personal interests include hiking in nature with friends and family,
              cycling, camping, jogging, and swimming. These interests serve as a
              health balance to screen work. I also help with childcare and dog care
              in the family.
            </p>
          </>
        )}
